          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6">
              <div className="rounded-2xl overflow-hidden shadow-sm border border-gray-100">
                <Image
                  src="/images/factory-quality.webp"
                  alt="HUAXING quality inspection - gloved hand inspecting PCBA board"
                  width={550}
                  height={869}
                  className="w-full h-auto object-cover"
                />
                <div className="p-3 bg-white text-center text-xs text-gray-500 border-t border-gray-100">
                  In-line quality inspection — every board inspected before moving to next stage
                </div>
              </div>
