                ...
                <div className="space-y-5">
                  ...
                  <div className="flex gap-4">
                    ...
                    <div>
                      ...
                      <a href={`mailto:${companyInfo.email}`} className="mt-0.5 text-sm text-brand-600 hover:text-brand-700 transition-colors block">
                        {companyInfo.email}
                      </a>
                    </div>
                  </div>
                  ...
                  <div className="flex gap-4">
                    ...
                    <div>
                      ...
                      <a href={`tel:${companyInfo.phone.replace(/\D/g, '')}`} className="mt-0.5 text-sm text-brand-600 hover:text-brand-700 transition-colors block">
                        {companyInfo.phone}
                      </a>
                      <a href={`tel:${companyInfo.phone2.replace(/\D/g, '')}`} className="text-sm text-brand-600 hover:text-brand-700 transition-colors block">
                        {companyInfo.phone2}
                      </a>
                    </div>
                  </div>
