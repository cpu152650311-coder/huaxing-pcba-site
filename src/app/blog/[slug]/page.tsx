...
const posts: Record<string, BlogPost> = {
  ...
  'dfm-checklist-pcb-assembly': {
    ...
    content: [
      'Design for Manufacturing (DFM) is the most cost-effective quality control you can implement. A proper DFM review before sending your design to production catches issues that would otherwise cause delays, re-spins, and added costs.',
      '## Why DFM Matters',
      'A single omitted solder mask dam, misplaced via, or inadequate component clearance can turn a 5-day turnaround into a 3-week re-spin. DFM review is your safety net — and at HUAXING, we provide it free on every project.',
      '## Pad Design Checklist',
      '- **SMD pad dimensions**: Follow IPC-7351 standards for each component package',
      '- **Toe, heel, side clearance**: Minimum 0.05mm beyond component termination',
      '- **Thermal reliefs**: Use on pads connected to large copper pours or planes (spoke width 0.25–0.4mm)',
      '- **Solder mask dams**: Minimum 0.075mm web width between adjacent SMD pads',
      '- **NSMD vs SMD pads**: Non-solder-mask-defined (NSMD) preferred for fine-pitch BGAs',
      '## Component Spacing & Placement',
      '- **Component-to-component**: Minimum 0.3mm edge-to-edge for passives, 0.5mm for ICs',
      '- **Edge clearance**: No components within 5mm of board edge for depanelization',
      '- **Heavier components**: Through-hole reinforcement or adhesive under heavy parts (>5g)',
      '- **Polarity markings**: Clearly visible after assembly (silkscreen on PCB, not on paste layer)',
      '- **Test points**: Minimum 1mm diameter, accessible from one side, on 2.54mm grid',
      '## Panelization Guidelines',
      '- **Rail width**: 5–10mm tooling rails on top and bottom',
      '- **Tooling holes**: 3mm holes at opposite corners, ±0.05mm tolerance',
      '- **V-score vs tab-routing**: V-score for rectangular boards, tab-routing for irregular shapes',
      '- **Mouse bites / breakaways**: 0.5mm depth on each side, 2–4 per tab',
      '- **Fiducials**: 1mm solid copper circle on mask opening, minimum 3 per panel side',
      '## Solder Mask & Silkscreen',
      '- **Solder mask clearance**: 0.05–0.1mm larger than pad on each side',
      '- **Min solder mask web**: 0.075mm between features',
      '- **Silkscreen over vias**: Avoid — causes readability issues',
      '- **Text height**: Minimum 0.8mm for readability after assembly',
      '## Via & Hole Design',
      '- **Via-in-pad**: Must be filled and plated over (conductive or non-conductive fill)',
      '- **Tented vias**: Cover with solder mask if no probing needed',
      '- **Minimum annular ring**: 0.075mm for outer layers, 0.1mm for inner layers',
      '- **Aspect ratio**: Maximum 10:1 for through-hole plating reliability',
      '## Final DFM Checklist',
      '1. Run DRC (Design Rule Check) with your manufacturer\'s capabilities',
      '2. Verify netlist matches schematic (netlist compare)',
      '3. Check for unconnected copper (orphans)',
      '4. Confirm stackup matches impedance requirements',
      '5. Verify BOM has manufacturer part numbers (MPNs) not just generics',
      '6. Include assembly drawings with mechanical dimensions',
      '7. Provide pick-and-place file with centroid data',
      'At HUAXING, our engineering team performs this DFM review on every incoming project. We flag issues before they become problems — at no extra cost.',
    ],
  },
};
